			...
			<div class="container">
				<div class="row">
					<div class="col d-flex flex-row">
						<div class="top_bar_contact_item"><div class="top_bar_icon"><img src="https://res.cloudinary.com/dxfq3iotg/image/upload/v1560918577/phone.png" alt=""></div>34 99823 132111</div>
						<div class="top_bar_contact_item"><div class="top_bar_icon"><img src="https://res.cloudinary.com/dxfq3iotg/image/upload/v1560918597/mail.png" alt=""></div>Zafira@gmail.com</div>
							...
							<div class="top_bar_user">
								...
								<?php if($userData): ?>									
									<ul class="standard_dropdown main_nav_dropdown">
										<li class="hassubs">
											<a href="#"><?= $userData->name ?><i class="fas fa-chevron-down"></i></a>
											<ul>
												<li><a href="<?= $BASE_URL ?>editprofile.php">Meu Perfil<i class="fas fa-chevron-down"></i></a></li>
												<!--<li><a href="logout.php">Sair<i class="fas fa-chevron-down"></i></a></li>	-->
												<li><a href="<?= $BASE_URL ?>logout.php" class="nav-link">Sair</a></li>											
											</ul>
										</li>
									</ul>																	
									<?php else: ?>
								<div class="user_icon"><img src="https://res.cloudinary.com/dxfq3iotg/image/upload/v1560918647/user.svg" alt=""></div>
								<div><a href="auth.php">Register</a></div>
								<div><a href="auth.php">Sign in</a></div>
								<?php endif; ?>
							</div>
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-lg-2 col-sm-3 col-3 order-1">
						<div class="logo_container">
							<div class="logo"><a href="<?= $BASE_URL ?>index.php">Zafira</a></div>
						</div>
					</div>
							...
							<div class="header_search_content">
								<div class="header_search_form_container">
									<form action="#" class="header_search_form clearfix">
										<input type="search" required="required" class="header_search_input" placeholder="Buscar Produto">
					...
					<div class="col">
						...
						<div class="main_nav_content d-flex flex-row">
							...
							<div class="main_nav_menu">
								<ul class="standard_dropdown main_nav_dropdown">
									<li><a href="<?= $BASE_URL ?>index.php">Home<i class="fas fa-chevron-down"></i></a></li>
									<li class="hassubs">
